...
/**
 * The DocumentPropertiesResponse model module.
 * @module model/DocumentPropertiesResponse
 * @version 1.0.21
 */
class DocumentPropertiesResponse {
    /**
     * Constructs a new <code>DocumentPropertiesResponse</code>.
     * @alias module:model/DocumentPropertiesResponse
     * @param properties {module:model/DocumentProperties} 
     */
    constructor(properties) { 
        
        DocumentPropertiesResponse.initialize(this, properties);
    }
    ...
    /**
     * Constructs a <code>DocumentPropertiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentPropertiesResponse} obj Optional instance to populate.
     * @return {module:model/DocumentPropertiesResponse} The populated <code>DocumentPropertiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentPropertiesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentPropertiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentPropertiesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentPropertiesResponse.RequiredProperties) {
            if (!data[property]) {
...
DocumentPropertiesResponse.RequiredProperties = ["properties"];

/**
 * @member {module:model/DocumentProperties} properties
 */
DocumentPropertiesResponse.prototype['properties'] = undefined;
...
export default DocumentPropertiesResponse;
